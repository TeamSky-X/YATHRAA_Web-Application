						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Discover</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
                                        ...
                                        <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Tourists Guides</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
                                            <ul id="menu-academico-sub" >
                                                <li id="menu-academico-avaliacoes" ><a href="create-guide.php">Create New</a></li>
                                                <li id="menu-academico-avaliacoes" ><a href="manage-guide.php">Manage</a></li>
									...
									<li id="menu-academico" ><a href="manage-users.php"><i class="fa fa-users" aria-hidden="true"></i><span>Manage Users</span><div class="clearfix"></div></a></li>
                                        <li id="menu-academico" ><a href="manage-enterprises.php"><i class="fa fa-building" aria-hidden="true"></i><span>Manage Enterprises</span><div class="clearfix"></div></a></li>
