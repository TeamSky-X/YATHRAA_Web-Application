				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Packages</h2>
                        ...
                        <form class="form-inline" action="manage-packages.php" method="post">
							...
							<td><?php echo htmlentities($result->Creationdate);?></td>
                              <td>
                                  <?php if($result->Status==1) : ?>
                                      <p>Approved</p>
                                  <?php else : ?>
                                      <form method="post" action="approve-package.php">
                                          <!--                                            <input type="hidden" name="id" value="--><?php //echo $_POST['id']; ?><!--">-->
                                          <input type="hidden" name="approve" value="<?php echo $result->PackageId;?>"><button type="submit">Approve</button>
                                      </form>
                                  <?php endif; ?>
                              </td>
