...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Manage Forum</li>
            </ol>
            <div class="agile-grids">
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        <h2><b>Manage Forum</b>&nbsp&nbsp&nbsp<button>Reported Posts</button></h2>

                        <form class="form-inline" action="manage-forum.php" method="post">
                        ...
                        <table id="table">
                            ...
                            if($query->rowCount() > 0)
                            {
                                ...
                                {				?>
                                        ...
                                        <td width="50"><?php echo $result->EmailId;?></td>
                                        <td width="200"><?php echo htmlentities($result->Topic);?></a></td>
                                        <td width="400"><?php echo htmlentities($result->FeedBack);?></td>
                                        <td width="50"><?php echo htmlentities($result->PostingDate);?></td>
                                    <td>
                                        <?php if($result->Status==1) : ?>
                                           <p>Approved</p>
                                        <?php else : ?>
                                            <form method="post" action="approve-post.php">
                                                <!--                                            <input type="hidden" name="id" value="--><?php //echo $_POST['id']; ?><!--">-->
                                                <input type="hidden" name="approve" value="<?php echo $result->id;?>"><button type="submit">Approve</button>
                                            </form>
                                        <?php endif; ?>
                                    </td>
