...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="update tbltourpackages set Package=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails, PackageContact=:pcontact, where PackageId=:pid";
