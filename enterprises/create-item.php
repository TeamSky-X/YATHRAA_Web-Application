...
//$query-> bindParam(':password', $password, PDO::PARAM_STR);
        ...
        $sql="INSERT INTO tblmarket(ProductId,etId,ProductName,ProductType,SellerDetails,ProductPrice,ProductFeatures,ProductDetails,ProductImage) VALUES(:pid,:etId,:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
        $query = $dbh->prepare($sql);
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Add Item</li>
            </ol>
            <!--grid-->
            <div class="grid-form">
