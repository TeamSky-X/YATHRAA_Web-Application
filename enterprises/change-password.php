...
$username=$_SESSION['alogin'];
	$sql ="SELECT Password FROM tblenterprises WHERE username=:username and password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblenterprises set password=:newpassword where username=:username";
