...
$sql = "SELECT tblbooking.BookingId as bookid,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tbltourpackages.PackageName as pckname,tblbooking.PackageId as pid,tblbooking.FromDate as fdate,tblbooking.ToDate as tdate,tblbooking.Comment as comment,tblbooking.status as etId,tblbooking.etId as status,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate,tblbooking.etId as etId from tblusers join  tblbooking on  tblbooking.UserEmail=tblusers.EmailId join tbltourpackages on tbltourpackages.PackageId=tblbooking.PackageId ";
//$sql="SELECT * FROM  tblbooking WHERE etId=:etId ";
$query = $dbh -> prepare($sql);
//$query-> bindParam(':etId', $user['etId'], PDO::PARAM_INT);
$query->execute();
