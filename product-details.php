...
<html>
<head>
    <title>YATHRAA | Product Details</title>
...
<div class="banner-3">
    <div class="container">
        <h1 class="wow zoomIn animated animated" data-wow-delay=".5s"
            style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Travelling Equipments</h1>
    </div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
                            ...
                            <ul>
                                ...
                                <?php if ($_SESSION['login']) {
                                    ...
                                    <li class="spe" align="center">
                                        <button type="submit" name="submit2" class="btn-primary btn">Add to cart
                                        </button>
                                    </li>
                                <?php } else { ?>
                                    <li class="sigi" align="center" style="margin-top: 1%">
                                        <a href="#" data-toggle="modal" data-target="#myModal4" class="btn-primary btn">Add
                                            to Cart</a></li>
                                <?php } ?>
                                <div class="clearfix"></div>
                            </ul>
